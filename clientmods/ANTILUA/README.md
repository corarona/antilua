...
| **fishbot** | Automatic fishing bot with state machine (Mineclonia/VoxeLibre). |
...
| **schembuilder** | Schematic builder: load/preview via particles, place via AutoSchemPlace/SchemBuilderBot/RhythmBuildBot, auto-loot materials. `.schembuild`, `.spos1`, `.spos2`, `.ssave`. |
