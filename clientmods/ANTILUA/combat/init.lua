...
-- AutoCombatLog: disconnect and teleport randomly when other players are
-- detected nearby. Moved here from place/bot_tools.lua — it's a combat
-- evasion cheat, not a block-placement feature.
ws.rg("AutoCombatLog", { category = "Player", setting = "autoclog",
	description = "Log combat data automatically",
