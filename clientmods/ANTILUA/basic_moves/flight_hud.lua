...
local hud_defs = {
	{key = "bg",      type = "image", align = {x=1,y=1}, offset={x=-262,y=-309}, scale={x=2,y=2},               text="df_horizon.png"},
	{key = "line",    type = "image", align = {x=1,y=1}, offset={x=-247,y=-294}, scale={x=HORIZON_SCALE,y=HORIZON_SCALE}, text="horizon_indicator.png"},
	{key = "compass", type = "text",  align = {x=0.5,y=0.5}, offset={x=-177,y=-177}, color=0xFFFFF0,             text=""},
	{key = "pitch",   type = "text",  align = {x=0.5,y=1}, offset={x=-174,y=-340}, color=0xFF66AAFF,             text=""},
	{key = "target",  type = "text",  align = {x=0.5,y=1}, offset={x=-174,y=-400}, color=0xFF88FF88,             text=""},
	{key = "alt_bar", type = "text",  align = {x=0.5,y=1}, offset={x=-15,y=-290},  color=0xFF88FF88,             text=""},
	{key = "alt",     type = "text",  align = {x=0.5,y=1}, offset={x=-30,y=-50},   color=0xFF88FF88,             text=""},
	{key = "speed",   type = "text",  align = {x=1,y=1},   offset={x=-200,y=-50},  color=0xFFFFCC66,             text=""},
	{key = "speed_bar", type = "text", align = {x=1,y=1}, offset={x=-200,y=-38},  color=0xFFAAAAAA,             text=""},
}
