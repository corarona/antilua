...
dofile(modpath .. "/test_combat.lua")
dofile(modpath .. "/test_schembuilder.lua")
dofile(modpath .. "/test_autoeat.lua")
dofile(modpath .. "/test_formspec.lua")
dofile(modpath .. "/test_basic_moves.lua")
dofile(modpath .. "/test_devtools.lua")
...
dofile(modpath .. "/test_bigmap.lua")
dofile(modpath .. "/test_explorebot.lua")
dofile(modpath .. "/test_mapviewer.lua")
...
core.register_on_mods_loaded(function()
	...
	test_basic_moves(al_test)
	test_devtools(al_test)
	test_help(al_test)
	test_nlist(al_test)
	test_tps_client(al_test)
	test_al_profile(al_test)
	test_hud_layout(al_test)
	...
	test_bigmap_api(al_test)
	test_bigmap_pixels(al_test)
	test_bigmap_clear(al_test)
	test_bigmap_live_capture(al_test)
	test_explorebot(al_test)
	test_mapviewer(al_test)
	...
	test_core_api(al_test)
	test_clientmod_features(al_test)
	test_tracers(al_test)
